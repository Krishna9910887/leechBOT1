...
async def get_stats(event, key="home"):
    ...
    btns = ButtonMaker()
    btns.ibutton("Back", f"bot1 {user_id} stats home")
    if key == "home":
        btns = ButtonMaker()
        btns.ibutton("Bot Stats", f"bot1 {user_id} stats stbot")
        btns.ibutton("OS Stats", f"bot1 {user_id} stats stsys")
        btns.ibutton("Repo Stats", f"bot1 {user_id} stats strepo")
        btns.ibutton("Bot Limits", f"bot1 {user_id} stats botlimits")
        ...
        official_v = (
            await cmd_exec(
                f"curl -o latestversion.py https://raw.githubusercontent.com/weebzone/SEARCH-X/{config_dict['UPSTREAM_BRANCH']}/bot/version.py -s && python3 latestversion.py && rm latestversion.py",
                True,
            )
        )[0]
        msg = BotTheme(
    ...
    btns.ibutton("Close", f"bot1 {user_id} close")
    ...
    try:
        bot_cmds = [
            ...
            BotCommand(
                ...
                "Get detailed help about the hONEY Bot",
            ),
            BotCommand(
